...
interface FeatureListItem<F extends string> {
  label: string;
  feature: F;
}

interface FeatureListSection<F extends string> {
  title: string;
  items: readonly FeatureListItem<F>[];
}

interface FeatureListItemWithPath<F extends string> extends FeatureListItem<F> {
  path: string;
}

interface FeatureListSectionWithPath<F extends string>
